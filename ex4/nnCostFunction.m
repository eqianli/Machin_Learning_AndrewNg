...
%vectorized binary y = 5000 x 10 
yVec = eye(num_labels)(y, :);

%cost function for each class
kthJ = -yVec .* log(a3) - (1-yVec) .* log(1 - a3);

J =  sum(sum(kthJ, 2))/m; 

%regularization terminal
...
%step 3  
  d_2 = (Theta2' * d_3)(2:end, 1) .* sigmoidGradient(z_2);
